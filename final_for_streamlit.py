...
# ==============================================================================
# 13. EXPLICABILITÉ DE XGBOOST AVEC SHAP (CORRIGÉ)
# ==============================================================================
...
if model_to_explain_shap in best_estimators:
    ...
    # Gérer à la fois les matrices creuses et denses à la sortie du pré-processeur
    ...
    # Gérer les différents formats de sortie de .shap_values()
    if isinstance(shap_values, list):
        shap_values_for_plot = shap_values[1] # Cas moderne: [classe_0, classe_1]
    else:
        shap_values_for_plot = shap_values # Cas plus ancien: une seule matrice
